  ...
  <div id="wrapper">
      ...
      <div class="container">
        ...
        <div class="card" style="background: #1a1a1a; border-radius: 3px;">
          <?php
            ...
            $where = "`provider` = '".$provider."' AND `datatype` = 'LC' ORDER BY cuid ASC";
            $pageLink = 'casino/'.$provider.'/';
          ?>
        ...
        <div class="gameListCasino">
          <div class="gameListCasinoColoumn">
            <a href="<?php echo $urlweb; ?>/casino/BigGaming">
              <div class="casinoListBox" style="background: url('<?php echo $urlweb; ?>/upload/BigGaming.gif') no-repeat #071d2a; background-size: 100% 100%; background-position: center center; border: 1px solid rgb(255,255,255,0.5);">
              </div>
            </a>
          </div>
          <div class="gameListCasinoColoumn">
            <a href="<?php echo $urlweb; ?>/casino/Evolution">
              <div class="casinoListBox" style="background: url('<?php echo $urlweb; ?>/upload/evo.gif') no-repeat #071d2a; background-size: 100% 100%; background-position: center center; border: 1px solid rgb(255,255,255,0.5);">
              </div>
            </a>
          </div>
          <div class="gameListCasinoColoumn">
            <a href="<?php echo $urlweb; ?>/casino/DreamGaming">
              <div class="casinoListBox" style="background: url('<?php echo $urlweb; ?>/upload/dg.gif') no-repeat #071d2a; background-size: 100% 100%; background-position: center center; border: 1px solid rgb(255,255,255,0.5);">
              </div>
            </a>
          </div>
        </div>
    ...
    <section class="mt-5 mb-5 d-block d-sm-none">
      <div class="container">
        <?php
          if(isset($_GET['slug'])){
            $where = "provider = '".$_GET['slug']."' AND `datatype` = 'LC' ORDER BY cuid ASC";
            $sql_3 = mysqli_query($conn,"SELECT * FROM `tb_gamelist` WHERE $where") or die(mysqli_error($conn));
            $s33 = mysqli_num_rows($sql_3);
            if($s33 == 0){
              echo '
