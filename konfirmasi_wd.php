      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-6">
            ...
            <div class="card" style="background-color: #000;">
              <div class="card-body p-2">
                <div style="background-color: var(--mode-greydark); padding: 15px;">
                  <p style="font-size: 14px;">Permintaan Penarikan anda sudah kami terima, Berikut Informasi Penarikan Anda:</p>
                  <table class="table">
                    <tr>
            ...
            <a href="<?php echo $urlweb;?>/hasil_wd/?trxID=<?php echo $_GET['trxID']; ?>" class="btn btn-secondaries w-100 mt-4 mb-3" style="height: 40px; line-height: 30px!important;">KONFIRMASI</a>
