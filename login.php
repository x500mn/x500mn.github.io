        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <?php
                  ...
                  ?>
            <form role="form" class="mt-3 mb-4" action="<?php echo $urlweb; ?>/login-proses.php" method="POST">
              ...
              <button type="submit" name="submit" value="submit" class="btn btn-secondaries w-100 mt-3" style="height: 40px;">MASUK</button>
              <p class="text-center mt-3 mb-3">Belum Punya Akun?</p>
              <a href="<?php echo $urlweb;?>/register/" class="btn btn-main w-100" style="height: 40px; line-height: 30px!important;">BUAT AKUN</a>
            </form>
          </div>
          <div class="col-sm-3"></div>
        </div>
